...
module.exports = class extends Generator {
  ...
  writing() {
    ...
    this.fs.copy(this.templatePath('index.ts'), this.destinationPath('index.ts'));

    this.fs.copy(this.templatePath('mocha.opts'), this.destinationPath('mocha.opts'));
